...
public:
	...
	static mythFFmpegEncoder* CreateNew(void* hwnd, int streamtype,int level,int width,int height);//º¯ÊýÈë¿Ú
public:
	void* hwnd;
protected:
	bool Init();
	mythFFmpegEncoder(void* phwnd, int streamtype, int level,int width,int height);
	//AVCodec* avCodec;
